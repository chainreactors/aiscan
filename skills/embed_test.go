...
func TestLoadEmbeddedSkills(t *testing.T) {
	...
	expected := []string{"aiscan", "ani", "ina", "ioa", "browser", "scan", "gogo", "spray", "katana", "fuzz", "zombie", "neutron", "sniper", "verify", "report", "web_search", "web_fetch", "vision", "parse_results", "filter_results"}
