...
func TestAgentConsoleArgsForLine(t *testing.T) {
	tests := []struct {
		...
		{name: "bare slash opens help", input: "/", wantArgs: []string{"/help"}},
		{name: "reset", input: "/reset", wantArgs: []string{"/reset"}},
		{name: "continue", input: "/continue", wantArgs: []string{"/continue"}},
		{name: "stop", input: "/stop", wantArgs: []string{"/stop"}},
		{name: "followup", input: "/followup summarize later", wantArgs: []string{"/followup", "summarize later"}},
